...
public class Init extends Application {
	...
	private StackPane graphicsStack = new StackPane();
	...
	private void swapGraphicsPanes () {
		...
		this.mainBorderPane.setCenter(this.popMngr.getActiveDriver().getUiNode());
	}
    ...
    public void start (Stage stage) {
        ...
        //---ADD POPULATIONS TO UI---//
        /*
        this.graphicsStack = new StackPane();
        this.graphicsStack.getChildren().add(basic2D.getUiNode());
        this.graphicsStack.getChildren().add(basic3D.getUiNode());
        this.graphicsStack.setStyle("" +
        ...
        */
        ...
        //mainBorderPane.setCenter(graphicsStack);
        mainBorderPane.setCenter(this.popMngr.getActiveDriver().getUiNode());
